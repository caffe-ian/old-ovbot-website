    ...
    paypal.Buttons({
      ...
      onApprove: function(data, actions) {
        return actions.order.capture().then(function(details) {
          ...
          itemname = b['name']
          quantity = b['quantity']
          var data = {'price': priceTotal, 'success': success, 'itemname': itemname, 'quantity': quantity, 'userid': document.getElementById("item-options").getAttribute("userid"), 'username': document.getElementById("item-options").getAttribute("username"), 'csrfmiddlewaretoken': csrftoken, 'gift': "True", 'gifterid': '{{gifterid}}', 'giftername': '{{giftername}}' };
